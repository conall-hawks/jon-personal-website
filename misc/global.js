...
/* ########################################################################## */
/* #### Throttle. ###################### Usage: throttle(function, time) #### */
/* ########################################################################## */
function throttle(n,l,t){var a,e,u,r,i=0;t||(t={});var o=function(){i=t.leading===!1?0:Date.now(),a=null,r=n.apply(e,u),a||(e=u=null)},c=function(){var c=Date.now();i||t.leading!==!1||(i=c);var f=l-(c-i);return e=this,u=arguments,0>=f||f>l?(a&&(clearTimeout(a),a=null),i=c,r=n.apply(e,u),a||(e=u=null)):a||t.trailing===!1||(a=setTimeout(o,f)),r};return c.cancel=function(){clearTimeout(a),i=0,a=e=u=null},c};
...
$(window).scroll(throttle(contentSlider, 100));
...
// Throttle prevents lag.
$(window).scroll(throttle(navbar, 100));
